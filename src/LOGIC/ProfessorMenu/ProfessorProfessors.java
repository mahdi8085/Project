...
import GUI.Main;
import LOGIC.Person.*;
import LOGIC.StudentMenu.StudentProfessors;
...
public class ProfessorProfessors implements Initializable {

    static Logger log = LogManager.getLogger(ProfessorProfessors.class);
