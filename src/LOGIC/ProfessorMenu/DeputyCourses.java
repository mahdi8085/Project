...
public class DeputyCourses implements Initializable {

    static Logger log = LogManager.getLogger(DeputyCourses.class);
    ...
    public void editCourses(ActionEvent event) throws IOException {

        // create a new main
        Main main = new Main();

        // change scene
        main.changeScene("ProfessorMenu\\DeputyEditCourses.fxml");
    }
